...
function save_hat_euclidean(s::Int)
    ##
    names_data = (:CE, :NS)
...
function get_hat_euclidean(
    ...
    ## Saving Pathing
    dir_model = "results/Euclidean/$(name_data)/$(name_model)/seed_$(seed)_ratiotrain_$(srt)_ratioval_$(srv)"
    dir_exp = savename(
